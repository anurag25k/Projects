...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Ann<b style="color: #06C167; ">Bramha</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Pimpri$Pimpri\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $Pimpri=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"Chinchwad\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $Chinchwad=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"PimpleSaudagar\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $PimpleSaudagar=$ro5['count'];
            

    ?>
var xValues = ["Male","Female"];
var xplace=["Pimpri","Chinchwad","PimpleSaudagar"];
var yplace=[<?php echo json_encode($Pimpri,JSON_HEX_TAG);?>,<?php echo json_encode($PimpleSaudagar,JSON_HEX_TAG);?>,<?php echo json_encode($Chinchwad,JSON_HEX_TAG);?>];
